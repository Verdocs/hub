...
/// <summary>Details for <see cref="Resources.Brands.CreateAsync"/>.</summary>
public sealed record CreateBrandRequest
{
    /// <summary>A key unique within the organization: lowercase alphanumeric plus hyphens, up to 63 characters.</summary>
