...
function PageButton({ selected, onClick, children, label }: PageButtonProps) {
  return (
    <button
      type="button"
      aria-label={label}
 ...
 * the data set.
 */
export default function Pagination({ selectedPage = 0, itemCount = 0, perPage = 10, onSelectPage }: PaginationProps) {
