...
describe('VerdocsTemplateDocumentPageComponent', () => {
  @Component({
    imports: [ VerdocsTemplateDocumentPageComponent ],
    template: `
  ...
  it('sizes the host from the page dimensions', () => {
    ...
    const host: HTMLElement = fixture.nativeElement.querySelector('verdocs-template-document-page');
