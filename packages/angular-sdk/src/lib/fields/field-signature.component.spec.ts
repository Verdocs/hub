...
import { VerdocsFieldSignatureComponent } from './field-signature.component';
...
describe('VerdocsFieldSignatureComponent', () => {
  @Component({
    imports: [ VerdocsFieldSignatureComponent ],
    template: `
  ...
  const host = (fixture: { nativeElement: HTMLElement }): HTMLElement =>
    fixture.nativeElement.querySelector('verdocs-field-signature') as HTMLElement;

  it('renders the signing affordance and reports clicks when unsigned', () => {
    const fixture = TestBed.createComponent(HostComponent);
    fixture.detectChanges();

    expect(affordance(fixture)?.textContent).toContain('Signature');
  ...
  it('renders the adopted signature image instead of the affordance when signed', () => {
    const fixture = TestBed.createComponent(HostComponent);
    fixture.componentInstance.signatureUrl.set(FAKE_URL);
    fixture.detectChanges();
